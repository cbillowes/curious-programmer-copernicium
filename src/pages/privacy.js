    ...
    >
      <div className="privacy max-w-screen-md mx-auto p-4">
        ...
        <p>
          ...
          Privacy Policy, do not hesitate to contact us on clarice@bouwer.dev.
        </p>

        <p>
          This Privacy Policy applies only to our online activities and is valid
          for visitors to our website with regards to the information that they
          shared and/or collect in Curious Programmer. This policy is not
        ...
        <p>
          ...
          clarice@bouwer.dev to tell me what you think about the content of the
          website so that I can produce better work and get an idea of how many
          people are accessing the site.
        </p>
        ...
        <p>
          There may be swearing but we keep it to a minimum as we try remain as
